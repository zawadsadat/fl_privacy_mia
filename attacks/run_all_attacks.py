"""
Implements all attack methods:
  1. Loss-threshold attack
  2. Confidence-threshold attack
  3. Entropy-threshold attack
  4. Calibrated loss attack (per-sample difficulty normalization)
  5. LiRA-style likelihood ratio attack (Carlini et al., 2022)
  6. Shadow-model Random Forest (multi-feature)
  7. Shadow-model Neural Network (multi-feature)
